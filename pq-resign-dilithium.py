#!/usr/bin/env python3
"""
pq-resign-dilithium.py - Post-quantum RPKI re-signing with Dilithium only

This script re-signs RPKI objects using only Dilithium algorithms (ML-DSA-44 and ML-DSA-65).
It's a focused version for processing only Dilithium variants.
...
- ROAs/Manifests (CMS): Replace 1 signature + public key in certificate
...
print("="*80)
print("POST-QUANTUM RPKI RE-SIGNING - DILITHIUM ONLY")
print("="*80)
